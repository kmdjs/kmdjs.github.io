; (function () {
    ...
    Vector2.prototype = {
        ...
        multiplyScalar: function (s) { this.x *= s; this.y *= s; return this },
        divideScalar: function (s) { if (s) { this.x /= s; this.y /= s } else { this.set(0, 0) }; return this },
    ...
    define(function (require, exports, module) { module.exports = Vector2; });
})();